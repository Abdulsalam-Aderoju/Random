...
with col1:
    ...
    user_input['Gender'] = st.selectbox(
        "Gender:", 
        ['Male', 'Female'], 
        index=['Male', 'Female'].index(selected_sample.get('Gender', 'Male'))
    )
...
with col2:
    ...
    user_input['Subject Combinations'] = st.selectbox(
        ...
        ['Applied commerce', 'Pure science', 'Theoretical Arts', 'Applied Arts', 
         'Theoretical commerce', 'Biological Science', 'Applied science'], 
        index=['Applied commerce', 'Pure science', 'Theoretical Arts', 'Applied Arts', 
               'Theoretical commerce', 'Biological Science', 'Applied science'].index(
